...
# is_availabe = ""
# is_availabe_as_bool = bool(is_availabe)
# is_availabe_as_int = int(is_availabe_as_bool)
# print(is_availabe_as_bool)
# print(is_availabe_as_int)
# print(type(is_availabe_as_int))
